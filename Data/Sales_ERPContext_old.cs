...
{
    public partial class Sales_ERPContext_old : DbContext
    {
        public Sales_ERPContext_old()
        {
        }

        public Sales_ERPContext_old(DbContextOptions<Sales_ERPContext_old> options)
            : base(options)
        {
        }
            ...
            modelBuilder.Entity<BankDetails>(entity =>
            {
               ...
               // entity.Property(e => e.Id).HasColumnName("id");
                ...
                entity.HasOne(d => d.Agent)
                    ...
                    .HasForeignKey(d => d.AgentId)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_Bank_Details_Bank_Agent_User");
