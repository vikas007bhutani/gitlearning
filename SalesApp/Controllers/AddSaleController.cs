    ...
    public class AddSaleController : Controller
    {
      ...
      //  private readonly IWebHostEnvironment _honstingEnvironment;
        ...
        public async Task<IActionResult> AddDeliveryInfo(NormalSaleVM standdetails)
        {
            ...
            try
            {
                ...
                if (standdetails.orderid >= 0)
                {
                    ...
                    {
                        TempData["UserMessage"] = new MessageVM() { title = "Error!", msg = "Delivery details are empty." };
                        // return View("Index", standdetails);
        ...
        protected string GenerateHTMLCM(NormalSaleVM _cashsaledetails)
        {
            ...
            int cnt = 0;
            htmlfile.Append("<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'><html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><title>Emailer</title><style>table{border: 0px solid #333;	}td{padding: 5px;}</style></head><body><table width='900' border='0' align='center' cellpadding='0' cellspacing='0'><tr><td height='15px' style='padding-left: 5px;text-align: center;color: #ffffff!important; '><h4 style='font-family: inherit; font-weight: 500;color: #fff !important; margin-top: 10px; margin-bottom: 10px; font-size: 18px; font-family: Gotham, Helvetica, Arial, sans-serif;'>Invoice</h4></td></tr><tr><td height='5'></td></tr><tr><td align='center' valign='top' style='font-family: Arial, Helvetica, sans-serif; font-size: 22px;  font-style: normal;'>Akbar International</td></tr><tr><td align='center' height='15'><img  src='http://ec2-13-232-169-227.ap-south-1.compute.amazonaws.com/akbarInternational/images/akbar.png' height='40px' width='200px'>");
            htmlfile.Append("<img src='http://ec2-13-232-169-227.ap-south-1.compute.amazonaws.com/akbarInternational/images/international.png' height='40px' width='200px'> </td></td> </tr><tr><td height='15' align='center' valign='top' style='font-family: Arial, Helvetica, sans-serif; font-size: 16px;  font-style: normal;'>Manufactures and exporters of Inlaid Articles</td></tr><tr><td style='font-family: Arial, Helvetica, sans-serif; font-size: 14px; float:left; font-style: normal;'><table width='900' border='0' cellpadding='0' cellspacing='0'><tbody><tr><td width='290' valign='top' style='border-right:solid 0px #333'>GST no: 09AKHPS5832P1ZA<br>State Uttar: Pardesh<br>State Code: 09 </td><td width='309' valign='top' style='border-right:solid 0px #333; '><span style='font-size: 22px'> Cash Memo</span><br>");
            if (_cashsaledetails.cashsaledetailsCM.Count > 0)
            {
                htmlfile.Append("Invoice No.: <strong>CM/" + _cashsaledetails.cashsaledetailsCM[0].unitid + "/" + _cashsaledetails.cashsaledetailsCM[0].orderid + "</strong></td>");
            }
            else
            { htmlfile.Append("Invoice No.: <strong>Cm/1/1383</strong></td>"); }
            htmlfile.Append("<td width='299' valign='top'><strong>" + _cashsaledetails.cashsaledetailsCM[0].username + "</strong><br>Date: " + DateTime.Now.ToString("dd/MM/yyyy") + "<br></td></tr></tbody></table></td></tr><tr><td valign='top' style='font-family: Arial, Helvetica, sans-serif; font-size: 13px; float:left; font-style: normal;'><table width='900' border='0' cellspacing='0' cellpadding='0' style='border:none'><tbody><tr><td width='85'>Name</td><td width='409'><strong>");
        ...
        protected string GenerateHTMLOF(NormalSaleVM _cashsaledetails)
        {
            ...
            {
                htmlfile.Append("Invoice No.: <strong>OF/" + _cashsaledetails.cashsaledetailsOF[0].unitid + "/" + _cashsaledetails.cashsaledetailsOF[0].orderid + "</strong></td>");
            }
            else
            { htmlfile.Append("Invoice No.: <strong>Cm/1/1383</strong></td>"); }
            ...
            {
                cnt++;
                htmlfile.Append("<tr><td valign = 'top'>" + cnt + "</td><td valign = 'top'><strong> " + item.itemdesc + " </strong><br> " + item.stockid + ")(H/D) </td><td align = 'right' valign = 'top'><strong> " + item.currency + " " + item.salevalue + " </strong></td><td align = 'right' valign = 'top'><strong> INR " + item.salevalueinr + " </strong></td></tr>");
            }
